...
const StepsOverviewScreen: React.FC = () => {
    ...
    const processChartData = (logs: DailyLog[], range: TimeRange, offset: number) => {
        ...
        // CAMBIO: Usar steps en lugar de calories
...
const averageSteps = stats?.summary.averageSteps || 0;
        ...
        <View style={styles.container}>
            ...
            <View style={styles.contentContainer}>
                ...
                <View style={styles.stackedContainer}>
                    {/* Promedio semanal de pasos */}
                    <View style={styles.cardWrapper}>
                        <AnalysisCard
                            icon="Footprints"
                            title="PROMEDIO"
                            value={`${Math.round(averageSteps).toLocaleString()} pasos`}
...
export default StepsOverviewScreen;
